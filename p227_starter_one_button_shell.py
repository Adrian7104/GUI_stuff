...
# buttons
command_textbox = tksc.ScrolledText(frame, height=15, width=100)
command_textbox.pack()

save_btn = tk.Button(frame, text="save", command=lambda:mSave)
save_btn.pack()

tracert_btn = tk.Button(frame, text="Trace RT", command=lambda:do_command("tracert"))
tracert_btn.pack()

nslookup_btn = tk.Button(frame,text="Lookup", command=lambda:do_command("nslookup"))
nslookup_btn.pack()
